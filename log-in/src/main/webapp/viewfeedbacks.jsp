...
<body>
    ...
    <%@page import="com.hemanth.feedbackview.feedbackviewuserDao,com.hemanth.feedbackview.*,java.util.*" %>
        <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
        
            <% List<feedbackview> list=feedbackviewuserDao.getAllRecords();
                ...
                <div class="main-container">
                    <div class="navcontainer">
                        ...
                        <form action="admin.html" method="post" >
                            <table border="1" width="100%" class="ok">
                                <tr>
                                    <th>Student_id</th>
                                    <th>email</th>
                                    <th>a</th>
